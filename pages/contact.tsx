      ...
      <div className="absolute flex flex-col w-full gap-5 px-5 text-white h-fit lg:w-3/5 xl:w-1/2 left-2 sm:left-32 top-2 sm:top-10 z-100 sm:gap-6 sm:px-0">
       ...
       Total Supply |  1,000,000,000,000 (One Trillion)
        ...
        <p className={tasaOrbiter.className}>
          ...
          Max Transaction Restriction: 125,000,000 tokens per transaction to protect the fair launch.
          
        
        </p>
        <p className={tasaOrbiter.className}>
       Anti Bot, Sniping, and Whale Prevention Metrics:
            Enabled in the contract to prevent malicious activities.
        </p>
        <p className={tasaOrbiter.className}>
     Contract Symbol | $TKINU
          <br />
        ...
        <a href="https://t.me/TsukiInuOfficial" target="_blank">
          <button
